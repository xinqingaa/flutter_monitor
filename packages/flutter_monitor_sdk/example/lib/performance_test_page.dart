...
class _PerformanceTestPageState extends State<PerformanceTestPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('性能测试页面'), backgroundColor: Colors.blue),
  ...
  /// 单次长阻塞测试 - 完全模仿 HomePage 的 JankTriggerButton 实现
