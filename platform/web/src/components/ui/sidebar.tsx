      ...
      >
        ...
        <div
          className={cn(
            ...
            // Keep icon width in sync with the gap spacer (no +2px) to avoid layout jitter.
            variant === "floating" || variant === "inset"
